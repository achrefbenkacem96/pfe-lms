...
CREATE TABLE `Question` (
    `id` VARCHAR(191) NOT NULL,
    `mainQuestion` VARCHAR(191) NOT NULL,
    `choices` JSON NOT NULL,
    `correctAnswer` VARCHAR(191) NOT NULL,
    `answeredResult` INTEGER NOT NULL DEFAULT -1,
    `statisticsId` VARCHAR(191) NULL,
...
CREATE TABLE `UserProgress` (
    ...
    UNIQUE INDEX `UserProgress_user_id_chapterId_key`(`user_id`, `chapterId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Purchase` (
    ...
    UNIQUE INDEX `Purchase_user_id_courseId_key`(`user_id`, `courseId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
