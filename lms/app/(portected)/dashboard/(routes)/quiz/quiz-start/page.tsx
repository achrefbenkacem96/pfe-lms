...
import QuizStartHeader from '@/components/quiz/QuizStartPage/QuizStartHeader';
import QuizStartQuestions from '@/components/quiz/QuizStartPage/QuizStartQuestions';
//@ts-ignore
function Page(props) {
    ...
    <div className="relative poppins flex flex-col px-24 mt-[35px] ">
      {selectQuizToStart === null ? (
        <div className="  h-svh flex flex-col gap-2 items-center justify-center">
          <Image src="/quiz/errorIcon.png" alt="" width={180} height={180} />
