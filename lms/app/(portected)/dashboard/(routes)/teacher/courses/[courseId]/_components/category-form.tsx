...
const formSchema = z.object({
  categoryId: z.string().min(1, "Category is required"), // Add custom error message
});
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Combobox
                      options={options} // Directly pass the options array
                      {...field}
                      onChange={(value) => field.onChange(value)} // Handle change
                      value={field.value} // Control the Combobox value
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
