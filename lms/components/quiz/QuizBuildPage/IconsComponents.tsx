...
// Define the type for an individual icon
type Icon = {
  faIcon: any; // Adjust the type if you know the specific type of FontAwesomeIcon
  isSelected: boolean;
};

function IconsComponents() {
  const [allIcons, setAllIcons] = useState<Icon[]>(iconsData);
