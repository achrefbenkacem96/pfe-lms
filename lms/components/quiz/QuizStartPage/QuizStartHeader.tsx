...
// Define type for the Quiz object from the context
interface Quiz {
  quizTitle: string;
  quizQuestions: { [key: string]: any }[]; // Replace with the correct type of quizQuestions
}

// Define props type for the QuizStartHeader component
interface QuizStartHeaderProps {
  parentTimer: number;
}

const QuizStartHeader: React.FC<QuizStartHeaderProps> = ({ parentTimer }) => {
